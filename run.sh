...
python finetune.py \
    ...
    --group_by_length \
    --wandb_project 'id-data-descriptor-llm' \
    --wandb_run_name 'gpt3.5-sft-qlora'
# python finetune.py \
#     --base_model 'meta-llama/Llama-2-13b-hf' \
#     --data_path './alpaca_data_gpt4_700.json' \
...
#     --group_by_length \
#     --wandb_project 'id-data-descriptor-llm' \
#     --wandb_run_name 'gpt3.5-sft-loha' && \
# python finetune.py \
#     --base_model 'meta-llama/Llama-2-13b-hf' \
#     --data_path './alpaca_data_gpt4_700.json' \
...
#     --group_by_length \
#     --wandb_project 'id-data-descriptor-llm' \
#     --wandb_run_name 'gpt3.5-sft-lokr' && \
# python finetune.py \
#     --base_model 'meta-llama/Llama-2-13b-hf' \
#     --data_path './alpaca_data_gpt4_700.json' \
...
#     --group_by_length \
#     --wandb_project 'id-data-descriptor-llm' \
#     --wandb_run_name 'gpt3.5-sft-prefix_tuning' && \
# python finetune.py \
#     --base_model 'meta-llama/Llama-2-13b-hf' \
#     --data_path './alpaca_data_gpt4_700.json' \
